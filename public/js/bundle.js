...
},{"./AddCharacter":9,"./Footer":13,"./Navbar":16,"react":"react"}],11:[function(require,module,exports){
'use strict';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.isReported ? 'Reported' : 'Reported Character'
                    )
                ),
                _react2.default.createElement(
                    'div',
...
var CharacterList = function (_React$Component) {
    ...
    _createClass(CharacterList, [{
        ...
        key: 'render',
        value: function render() {
            var Fakecharacters = this.state.characters;
...
var Me = function (_Component) {
    ...
    function Me(props) {
        ...
        var _this = _possibleConstructorReturn(this, (Me.__proto__ || Object.getPrototypeOf(Me)).call(this, props));
    ...
    _createClass(Me, [{
        ...
        value: function getCharacterCountSuccess(data) {
            this.setState({ characters: data });
        }
    }, {
        key: 'getCharacterCountFail',
        value: function getCharacterCountFail() {
            console.log('failed');
        }
    }, {
        key: 'componentDidMount',
        value: function componentDidMount() {
            ...
            $.ajax({ url: '/api/characters' }).done(function (data) {
                _this2.getCharacterCountSuccess(data);
            }).faile(function (data) {
                _this2.getCharacterCountFail();
            });
        }
    }, {
        key: 'callAjax',
        value: function callAjax() {
            ...
            $.ajax({ url: '/api/characters/fake' }).done(function (data) {
                _this3.getCharacterCountSuccess(data);
                console.log(data);
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                this.state.characters.map(function (character) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', { onClick: _this4.callAjax.bind(_this4), className: 'thumb-md', src: 'http://image.eveonline.com/Character/' + character.characterId + '_128.jpg' })
                    );
                })
            );
        }
...
},{"../actions/NavbarActions":6,"../stores/NavbarStore":25,"react":"react","react-router":"react-router"}],17:[function(require,module,exports){
'use strict';
...
},{"../actions/StatsActions":7,"../stores/StatsStore":26,"react":"react"}],18:[function(require,module,exports){
'use strict';
...
},{"./components/Navbar":16,"./routes":19,"history/lib/createBrowserHistory":35,"react":"react","react-dom":"react-dom","react-router":"react-router"}],19:[function(require,module,exports){
'use strict';
...
},{"./components/AddCharacter":9,"./components/App":10,"./components/Character":11,"./components/CharacterList":12,"./components/Home":14,"./components/Me":15,"./components/Stats":17,"react":"react","react-router":"react-router"}],20:[function(require,module,exports){
'use strict';
...
},{"../actions/AddCharacterActions":1,"../alt.js":8}],21:[function(require,module,exports){
'use strict';
...
},{"../actions/StatsActions":7,"../alt":8,"underscore":"underscore"}],27:[function(require,module,exports){
