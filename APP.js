...
app.get('/api/characters',function(req,res,next){
  ...
  var randomGender = _.sample(choices); //pick a random value from a array
        ...
        parser.parseString(xml,function(err,parsedXml){
          ...
          try{
            var name = parsedXml.eveapi.result[0].characterName[0] ,
                race = parsedXml.eveapi.result[0].race[0] ,
                bloodline =parsedXml.eveapi.result[0].bloodline[0];
 ...
 * return details character informations.
 */
 ...
 */
 ...
 app.get('/api/characters/fake', function(req,res,next){
    Character
    .find()
    .sort('-losses')
    .limit(5)
 ...
 /**
  * POST /api/report
  * Reports a character. Character is removed after 4 reposts
  */
...
//     },
//     function(callback){
//       Character.count({race:'Gallente'},function(err,gallente){
//         callback(err,gallente)
//       })
//     },function(callback){
//       Character.count({race:"Minmatar"},function(err,minmatar){
//         callback(err,minmatar);
//       })
//     },
//     function(callback) {
...
//           var topBloodCount = bloodlineCount[topBloodline];

//           callback(err,{bloodline:topBloodline,count:topBloodCount})
//         })
//     }
//   ],function(err,results){
//     if(err){return next(err)};
